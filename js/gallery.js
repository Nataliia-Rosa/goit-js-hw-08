...
<li class="gallery-item">
  ...
  gallery.insertAdjacentHTML('beforeend', itemsGallery);
}
...
function handleClick(e) {
  ...
  const imageCat = instance.element().querySelector('img');
  imageCat.addEventListener('click', () => {
    instance.close();
  });

  // За це сильно не бийте ;D
  ...
  imageCat.addEventListener('click', () => {
    ...
    setTimeout(() => {
      document.body.removeChild(catImg);
      instance.close();
    }, 1000);
  });
}
